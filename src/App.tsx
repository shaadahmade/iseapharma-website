...
export default function App() {
  ...
  const products = [
    // --- MOUTHWASH ---
    {
      ...
      name: "Periogum Plus",
      category: "Mouthwash",
      subtitle: "Advanced Oral Rinse for Gum Care",
    ...
    },
    {
      ...
      name: "PerioGum KF",
      category: "Mouthwash",
      subtitle: "Sensitive Oral Rinse for Gum Care",
    ...
    },
    {
      ...
      name: "Periogum BZ",
      category: "Mouthwash",
      subtitle: "Anti-Inflammatory Oral Rinse for Gum Care",
    ...
    },
    {
      ...
      category: "Mouthwash",
      subtitle: "Antiseptic Oral Rinse for Infection Care",
    ...
    // --- GUM PAINT ---
    {
      ...
      category: "Gum Paint",
      subtitle: "Daily Gum Paint for Bleeding Gums",
    ...
    },
    {
      ...
      name: "Orogum T",
      category: "Gum Paint",
      subtitle: "Daily Gum Paint for Receding Gums",
    ...
    // --- ORAL GEL ---
    {
      ...
      category: "Oral Gel",
      subtitle: "Daily Oral Gel for Ulcer Care",
    ...
    },
    {
      ...
      name: "Lignowin M Gel",
      category: "Oral Gel",
      subtitle: "Daily Oral Gel for Periodontal Care",
    ...
    },
    {
      ...
      name: "Clornida Gel",
      category: "Oral Gel",
      subtitle: "Daily Oral Gel for Infection Care",
    ...
    // --- TABLETS ---
    {
      ...
      category: "Tablets",
      subtitle: "Daily Dental Tablet for Inflammation Care",
    ...
    },
    {
      ...
      category: "Tablets",
      subtitle: "Daily Dental Tablet for Pain Care",
    ...
    // --- OTHER ---
    {
      ...
      name: "Orobloc 2% AD",
      category: "Other",
      subtitle: "Professional Injection for Pain-Free Procedures",
    ...
    },
    {
      ...
      category: "Other",
      subtitle: "Daily Softgel Capsule for Oral Tissue Care",
    ...
    },
    {
      ...
      category: "Other",
      subtitle: "Professional Gloves for Clinical Care",
    ...
    },
    {
      ...
      category: "Other",
      subtitle: "Daily Protein Supplement for Recovery Care",
  ...
  return (
    <div className="relative min-h-screen selection:bg-sky-200 overflow-x-hidden">
      ...
      <div className="fixed bottom-6 right-6 sm:bottom-10 sm:right-10 z-[100] flex flex-col gap-4">
        {/* Call Button */}
        <a
          href="tel:+918299378737"
          className="w-14 h-14 sm:w-16 sm:h-16 bg-sky-500 text-white rounded-full flex items-center justify-center shadow-[0_10px_40px_-10px_rgba(14,165,233,0.8)] hover:scale-110 transition-transform"
          aria-label="Call Us"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-[0_10px_40px_-10px_rgba(37,211,102,0.8)] hover:scale-110 transition-transform"
